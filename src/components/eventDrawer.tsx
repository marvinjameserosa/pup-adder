...
export default function EventDrawer({ event, isOpen, onClose }: EventDrawerProps) {
  ...
  return (
    <div className={`fixed inset-y-0 left-0 w-96 bg-background shadow-lg transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out z-50`}>
      <div className="p-4">
